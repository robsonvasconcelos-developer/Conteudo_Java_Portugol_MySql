...
select nome, tempo, preco,tb_categoria.tipoCurso, tb_categoria.parcelamentoSemJuros from tb_produto right join tb_categoria on tb_categoria.id = tb_produto.categoria_id where tb_categoria.tipoCurso = "Java";
